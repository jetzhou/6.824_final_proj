...
class extent_server {
 ...
 private:
  ...
  bool has_read_perm(extent_protocol::extentid_t, extent_protocol::userid_t, std::string);
  bool has_write_perm(extent_protocol::extentid_t, extent_protocol::userid_t, std::string);
  bool has_execute_perm(extent_protocol::extentid_t, extent_protocol::userid_t, std::string);
 ...
 public:
  ...
  int groupdel(extent_protocol::groupid_t, extent_protocol::userid_t, std::string, int &);
  int useradd(extent_protocol::userid_t, extent_protocol::groupid_t, extent_protocol::userid_t, std::string, int &);
  int userdel(extent_protocol::userid_t, extent_protocol::groupid_t, extent_protocol::userid_t, std::string, int &);
};
